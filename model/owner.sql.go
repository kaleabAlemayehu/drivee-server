...
UPDATE bookings b SET status = $3  FROM cars c WHERE b.car_id = c.id AND c.owner_id = $2 AND b.id = $1 RETURNING b.id, b.booking_no, b.car_id, b.renter_id, b.start_time, b.end_time, b.total_price, b.status, b.created_at, b.updated_at
`
